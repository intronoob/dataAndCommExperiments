...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(xValPin_GPIO_Port, xValPin_Pin);

    HAL_GPIO_DeInit(yValPin_GPIO_Port, yValPin_Pin);

    HAL_GPIO_DeInit(yPwrPin_GPIO_Port, yPwrPin_Pin);

    HAL_GPIO_DeInit(xPwrPin_GPIO_Port, xPwrPin_Pin);
